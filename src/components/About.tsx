...
const About = () => {
  ...
  //       <div>
  //         <h2 className="text-3xl font-bold mb-4">Yonetim & Hukuk</h2>
  //         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
  //           {yonetimHukukTeam.map((person) => (
  //             <PersonCard
  //               key={person.alt}
  //               name={person.name}
  ...
  //           Operasyonel Yonetim Ekibimiz
  //         </h2>
  //         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
  //           {operasyonelYonetimTeam.map((person) => (
  //             <PersonCard
  //               key={person.alt}
  //               name={person.name}
  //               position={person.position}
  ...
  //       <div>
  //         <h2 className="text-3xl font-bold mb-4">Ar-Ge Ekibimiz</h2>
  //         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
  //           {argeTeam.map((person) => (
  //             <PersonCard
  //               key={person.alt}
  ...
  //       </div>
  //       <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-4 h-58">
  //         {sections.map((section, index) => (
  //           <div key={index}>
  //             <img src={section.img} alt={section.alt} className="w-48 h-48" />
  //             <a
  //               key={`${section.name}-${index}`}
  //               href={section.href}
  //               className="hover:text-blue-800 text-blue-700 font-bold text-base cursor-pointer leading-4 dark:text-gray-400 dark:hover:text-white"
  //             >
  //               {section.name}
  //             </a>
  //           </div>
  ...
  //           <a href="https://github.com/koltukutsu" rel="nofollow">
